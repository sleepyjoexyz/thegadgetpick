  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-gray-100">
        <p className="text-xs text-gray-400">Deals are sourced from Amazon, Slickdeals, and Reddit. Prices and availability may change. As an Amazon Associate, The Gadget Pick earns from qualifying purchases.</p>
      </section>
    </main>
  );
}
