...
export async function generateMetadata(
  ...
  return {
    ...
    alternates: {
      canonical: `https://thegadgetpick.com/luggage/${slug}`,
    },
    openGraph: {
      title: article.title,
      description: article.excerpt,
      type: "article",
      url: `https://thegadgetpick.com/luggage/${slug}`,
    },
  };
}
  ...
  return (
    <article className="bg-white">
      ...
      <BreadcrumbSchema items={[
        ...
        { name: article.title, url: `https://thegadgetpick.com/luggage/${slug}` }
      ]} />
      {/* Breadcrumbs */}
      ...
      <section className="bg-blue-50 border-y border-blue-200 py-12 my-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            See the full comparison table with all 14 luggage options, specs, and prices.
          </p>
          <Link
            href="/luggage"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link href="/luggage/hardside-vs-softside">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Compare rigid and flexible luggage construction for your travel needs.
              </p>
            </div>
          </Link>
          ...
          <Link href="/luggage/carry-on-size-guide">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Learn airline carry-on rules to avoid gate checks and baggage fees.
              </p>
            </div>
          </Link>
          ...
          <Link href="/luggage/packing-tips">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Master efficient packing techniques for carry-on travel.
              </p>
            </div>
          </Link>
          ...
          <Link href="/luggage/best-for-business-travel">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow cursor-pointer">
              ...
              <p className="text-sm text-gray-600">
                Find luggage built with executive features and durability.
              </p>
            </div>
          </Link>
        </div>
